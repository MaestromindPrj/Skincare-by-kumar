...
const existingSoaps = [
  {
    ...
    price: 330,
    originalPrice: 390,
    benefits: ["Brightening", "Deep Cleansing"],
  ...
  },
  {
    ...
    price: 402,
    originalPrice: 470,
    benefits: ["Exfoliating", "Skin Smoothing"],
  ...
  },
  {
    ...
    price: 280,
    originalPrice: 350,
    benefits: ["Active Freshness", "Deodorizing"],
    tags: ["Brightness", "Hydrating", "Handcrafted Soaps"],
    category: "Handcrafted Soaps",
    ...
    keyIngredients: [
      { name: "Rosemary & Cypress Essential Oil", description: "Soothing botanical notes that tone and invigorate skin.", icon: "Leaf" },
      { name: "Cologne Spice Essence", description: "Delivers an instant burst of long-lasting fresh aroma.", icon: "Zap" },
      { name: "AloeVera Puree", description: "Deeply cools and rehydrates skin post-activity.", icon: "Droplet" },
  ...
  },
  {
    ...
    price: 280,
    originalPrice: 350,
    benefits: ["Pore Purifying", "Oil Control"],
    tags: ["Brightness", "Hydrating", "Handcrafted Soaps"],
    category: "Handcrafted Soaps",
    ...
    keyIngredients: [
      { name: "Bergamot, Lime & Lemon Oils", description: "Energizing citrus trio that purifies pores and balances oil.", icon: "Sun" },
      { name: "Yellow Bentonite & Kaolin Clay", description: "Draws out micro-toxins and excess skin sebum.", icon: "Sparkles" },
      { name: "AloeVera Puree", description: "Restores soothing hydration without heaviness.", icon: "Droplet" },
      { name: "Orange Peel Extract", description: "Natural botanical astringent for refreshed skin tone.", icon: "Leaf" }
    ]
  },
  {
    ...
    price: 402,
    originalPrice: 490,
    benefits: ["Cooling Freshness", "Anti-Pollution"],
    tags: ["Brightness", "Hydrating", "Handcrafted Soaps"],
    category: "Handcrafted Soaps",
    ...
    keyIngredients: [
      { name: "Spearmint & Lime Oil", description: "Delivers an invigorating, cooling crisp freshness.", icon: "Zap" },
      { name: "Green Tea Extract", description: "Rich in antioxidants that protect against urban pollution.", icon: "Leaf" },
      { name: "AloeVera Puree", description: "Deeply hydrates and restores skin moisture barrier.", icon: "Droplet" },
      { name: "Shea & Kokum Butter", description: "Leaves skin soft and nourished without tightness.", icon: "Heart" }
    ]
  },
  {
  ...
  },
  {
    ...
    price: 303,
    originalPrice: 380,
    benefits: ["Deep Hydration", "Nourishing"],
  ...
  },
  {
    ...
    price: 330,
    originalPrice: 400,
    benefits: ["Soothing Care", "Softening"],
    tags: ["Hydrating", "Baby Friendly", "Handcrafted Soaps"],
    category: "Handcrafted Soaps",
  ...
  },
  {
    ...
    price: 402,
    originalPrice: 480,
    benefits: ["Rich Moisture", "Aromatherapy"],
    tags: ["Hydrating", "Brightness", "Handcrafted Soaps"],
    category: "Handcrafted Soaps",
  ...
  },
  {
    ...
    price: 280,
    originalPrice: 350,
    benefits: ["Circulation Boost", "Purifying"],
    tags: ["Brightness", "Hydrating", "Handcrafted Soaps"],
    category: "Handcrafted Soaps",
