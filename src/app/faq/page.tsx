...
export default function FaqPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "For dry or sensitive skin, nourishing bars like Almond Cream or Zaarraa are ideal. For combination or acne-prone skin, French Red Clay and Indus River provide gentle clarifying benefits. For kids and delicate skin, Kiddos and Lush Oats offer hypoallergenic, fragrance-safe care."
    },
    {
    ...
    <div className="min-h-screen bg-white text-[#0F0F0F] py-12 sm:py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="p-6 rounded-2xl bg-[#FAF8F5] border border-[rgba(15,15,15,0.08)] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <a
            href="https://wa.me/919344884149?text=Hello%20Skincare%20By%20Kumar,%20I%20have%20a%20question"
            target="_blank"
            rel="noreferrer"
